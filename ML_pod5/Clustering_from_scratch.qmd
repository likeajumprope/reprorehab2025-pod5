...
2. Inspect the data. The data is structured in x-y coordinates: All x coordinates are in column one, the corresponding y coordinates are in column two.

3. Draw three random points from the data to initialize the centroids (you can use the `random` package). Plot them into the plot above,  in red.
